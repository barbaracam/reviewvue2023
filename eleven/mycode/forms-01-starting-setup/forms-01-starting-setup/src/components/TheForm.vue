<template>
  <form @submit.prevent="submitData" >
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <p v-if="userNameValidity === 'invalid'">Please enter Name</p>
    </div>
    ...
    <div class="form-control">
      ...
      <label for="confirm-terms">Agree with the policy</label>
    </div>
    <div>
...
export default {
  ...
  methods: {
    submitData(){
      ...
      console.log('Dropdown:' + this.referrer);
...
.form-control.invalid input, .form-control.invalid label{
